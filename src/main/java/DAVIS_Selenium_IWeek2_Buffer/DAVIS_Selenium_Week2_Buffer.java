 ...
 * File Name: DAVIS_Selenium_Week2_Buffer.java
 * Author: David Davis
 * Date: March 19, 2025
 */
package DAVIS_Selenium_IWeek2_Buffer;
...
public class DAVIS_Selenium_Week2_Buffer implements DAVIS_Selenium_IWeek2_Buffer{
	/**
	 * 1 Write a Java program to print Hello and your name.
	 */ 
	@Override
	public void Hello(BufferedReader reader) {
	    System.out.println("----------------------------------------------------");
	 ...
	 */ 
	@Override
	public void IsEqualTo(BufferedReader reader) {
	    System.out.println("----------------------------------------------------");
		 ...
		 */
	@Override
	public void SumOfTwoNumbers(BufferedReader reader) {
	    System.out.println("---------------------------------------------------------");
	 ...
	 */
	@Override
	public void HelloWorld(BufferedReader reader) {
	    System.out.println("---------------------------------------------------------");
  ...
  */
	@Override
	public void MulitplicationOfThreeNumbers(BufferedReader reader) {
	    System.out.println("---------------------------------------------------------");
